...
ISR( USI_START_VECTOR)
{
  ...
  */
  ...
  while ( bit_is_set(PIN_USI,PIN_USI_SCL) && bit_is_clear(PIN_USI,PIN_USI_SDA));

  if ( bit_is_clear(PIN_USI, PIN_USI_SDA) ){
