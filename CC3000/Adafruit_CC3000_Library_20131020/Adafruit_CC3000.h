...
class Adafruit_CC3000_Client : public Print {
 public:
  ...
  virtual ~Adafruit_CC3000_Client(void);
...
class Adafruit_CC3000 {
  ...
  Adafruit_CC3000();
    ...
    Adafruit_CC3000_Client* connectTCP(uint32_t destIP, uint16_t destPort); // HACK modified to return a pointer for ease of use
    Adafruit_CC3000_Client* connectUDP(uint32_t destIP, uint16_t destPort); // HACK modified to return a pointer for ease of use
